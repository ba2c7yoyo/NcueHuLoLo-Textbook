...
* 把網路線或 Wi-Fi 接上電腦，不過都看到這行了應該是沒問題
...
* [什麼是 ALLOWED_HOSTS](https://realnewbie.com/posts/django-beginner-guide-allowed-hosts-configuration-and-security)
* [static 與 staticfiles 的區別](https://realnewbie.com/posts/django-static-files-management-complete-guide-static-vs-staticfiles)
